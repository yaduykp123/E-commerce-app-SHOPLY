  ...
  />
        ...
        <div className="md:w-1/2">
          ...
          <div className="flex gap-4 mt-8">
            ...
            >
              {product.inStock ? "Add to Cart" : "Out of Stock"} <i className="fa-solid fa-cart-flatbed ml-1"></i>
            </button>
            ...
            >
              <Link to="/wishlist" className="flex items-center justify-center gap-2">
                <i className="fa-solid text-red-500 fa-heart"></i> Wishlist
              </Link>
            </button>
            ...
            <button
              ...
              className={`flex-1 py-3 rounded-lg font-semibold transition-all
                ${product.inStock
                  ? "border border-gray-300 hover:bg-gray-50 text-gray-800 active:scale-95"
